...
if __name__ == '__main__':
    ...
    torch.onnx.export(model,               # model being run
                  ...
                  args.save_dir+"transformer_mix.onnx",   # where to save the model (can be a file or file-like object)
    ...
    onnx_model = onnx.load(args.save_dir+"transformer_mix.onnx")
    onnx.checker.check_model(onnx_model)


    import onnxruntime

    ort_session = onnxruntime.InferenceSession(args.save_dir+"transformer_mix.onnx")
